...
impl BitsetCoverComparator {
    ...
    fn build_features(&self, frame: &VideoFrame, roi: &RoiConfig) -> Option<BitsetFeatures> {
...
fn roi_bounds(frame: &VideoFrame, roi: &RoiConfig) -> Option<(usize, usize, usize, usize)> {
