...
mod platform {
    ...
    impl SeekControl for MftSeeker {
    ...
    impl YPlaneStreamProvider for MftProvider {
        ...
        fn into_stream(self: Box<Self>) -> PlaneStreamHandle {
            ...
            PlaneStreamHandle::new(stream, Box::new(MftSeeker { tx: seek_tx }))
        }
    }
    ...
    fn run_loop(
        ...
        loop {
            ...
            let result = decode_mft(path.clone(), &mut context);
    ...
    fn decode_mft(path: PathBuf, context: &mut DecodeContext) -> YPlaneResult<()> {
